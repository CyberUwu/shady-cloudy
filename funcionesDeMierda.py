...
def code44(texto,codeViejo):      #sionaron
    ...
    if re.search('.*(sionaron[0-9]+[a-z][0-9]+)',str(texto)):
        texto = re.findall('.*(sionaron[0-9]+[a-z][0-9]+)',str(texto))[0]
    else:
        texto=codeViejo
    return texto
def code45(texto,codeViejo):      #submerzed
    if re.search('.*(submerzed[0-9]+[a-z][0-9]+)',str(texto)):
...
def code46(texto,codeViejo):      #thebestiaoficial
    if re.search('.*(bestia[0-9]+[a-z][0-9]+)',str(texto)):
        texto=re.findall('.*(bestia[0-9]+[a-z][0-9]+)',str(texto))[0]
    else:
        texto=codeViejo
    return texto
def code47(texto,codeViejo):      #drigo
    if re.search('.*(drigo[0-9]+[a-z][0-9]+)',str(texto)):
...
def code53(texto,codeViejo):      #xposed
    ...
    if re.search('.*(xposed[0-9]+[a-z][0-9]+.*)',str(texto)):
        print('hola')
...
def code60(texto,codeViejo):      #jjuandamoli16s181
    if re.search('.*(jjuandamoli[0-9]+[a-z][0-9]+)',str(texto)):
...
def code61(texto,codeViejo):      #shapez1650u8
    if re.search('.*(shapez[0-9]+[a-z][0-9]+)',str(texto)):
...
def code62(texto,codeViejo):      #pulmonary88q665
    if re.search('.*(pulmonary[0-9]+[a-z][0-9]+)',str(texto)):
...
def code63(texto,codeViejo):      #jasonr56w0w89
    if re.search('.*(jasonr[0-9]+[a-z][0-9]+)',str(texto)):
        texto=re.findall('.*(jasonr[0-9]+[a-z][0-9]+)',str(texto))[0]
    else:
        texto=codeViejo
    return texto

def code64(texto,codeViejo):      #attoficial
    if re.search('.*(attoficial.+)',str(texto)):
        texto=re.findall('.*(attoficial.+)',str(texto))[0]
    else:
        texto=codeViejo
    return texto
